...
namespace Lesson18_多线程
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            isRuning = false;
            //Console.ReadKey();
            //4.2通过线程提供的方法（注意在.Net core版本中无法终止 会报错)
            try
            {
                t.Abort();//终止线程
    ...
    //可以通过代码开启多线程，用多线程处理一些复杂的可能会影响主线程流程度的逻辑
    //关键字 Thread
}
